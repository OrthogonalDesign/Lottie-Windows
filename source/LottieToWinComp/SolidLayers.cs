    ...
    static class SolidLayers
    {
        ...
        sealed class SolidLayerTranslator : LayerTranslator
        {
            ...
            internal override bool IsShape =>
                !_context.Layer.Masks.Any() || _context.Layer.IsHidden || _context.Layer.Transform.Opacity.IsAlways(Opacity.Transparent);

            internal override CompositionShape? GetShapeRoot(TranslationContext context)
            {
                if (_context.Layer.IsHidden || _context.Layer.Transform.Opacity.IsAlways(Opacity.Transparent))
                {
